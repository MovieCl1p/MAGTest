...
namespace Core.Dispatcher
{
    public class Dispatcher : IDispatcher
    {
        ...
        public void DeclareSignal<TSignal>(string identifier = null)
        {
        ...
        public void Subscribe<TSignal>(Action<TSignal> callback, string identifier = null) where TSignal : ISignal
        {
